...
async function destroyCategory(category) {
    const ok = await confirm({
        ...
        message: `Hapus kategori ${category.code} — ${category.name}?`,
        confirmLabel: 'Hapus',
        variant: 'danger',
    });
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header-title>Kategori</template>
        <template #header-subtitle>Kelompok barang untuk klasifikasi stok</template>
                    ...
                    <table class="min-w-full divide-y divide-slate-200 text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr v-for="category in categories.data" :key="category.id">
                                ...
                                <td class="px-4 py-3 text-slate-700">{{ category.name }}</td>
                                <td class="px-4 py-3">
                                    <span
